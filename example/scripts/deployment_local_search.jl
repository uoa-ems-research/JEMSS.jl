...
logFileHeader = ["search", "iter", "i", "j", "usedLookup", "usedMove", "objVal", "bestObjVal", "totalAmbTravelDuration", "totalAmbBusyDuration", "avgResponseDurationMinutes", "callsReachedInTime", "iterTimeSeconds"] # ... and stationsNumAmbs
