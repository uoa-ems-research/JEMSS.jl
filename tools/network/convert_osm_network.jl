...
function readOsmNetworkFile(osmFilename::String;
	levels::Union{Set{Int},Compat.Nothing} = nothing, boundsLLA::Union{Geodesy.Bounds{LLA},Compat.Nothing} = nothing)
...
function convertOsmNetwork!(nodes::Vector{Node}, arcs::Vector{Arc};
	levels::Union{Set{Int},Compat.Nothing} = nothing, classSpeeds::Vector{Dict{Int,Float}} = [], classOffRoadAccess::Dict{Int,Bool} = Dict{Int,Bool}(), mergeArcsFunction::Function = mergeDuplicateOsmArcs!)
...
function convertOsmNetworkFile(osmFilename::String;
	levels::Union{Set{Int},Compat.Nothing} = nothing, boundsLLA::Union{Geodesy.Bounds{LLA},Compat.Nothing} = nothing, classSpeeds::Vector{Dict{Int,Float}} = [], classOffRoadAccess::Dict{Int,Bool} = Dict{Int,Bool}(), mergeArcsFunction::Function = mergeDuplicateOsmArcs!)
